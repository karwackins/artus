...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Artus - zamówienia') }}</title>
    ...
    <footer class="py-5 bg-dark">
        <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Artus 2021 | Mephdesign Strony WWW</p></div>
    </footer>
    <!-- Bootstrap core JS-->
