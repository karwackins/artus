            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @csrf <!-- {{ csrf_field() }} -->
                        ...
                        <input type="text" class="form-control m-3" name="customer_name" value="{{$order->customer_name}}" placeholder="Nazwa Klienta">
                        <label for="exampleFormControlInput1" class="form-label">Numer telefonu</label>
                        <input type="text" class="form-control m-3" name="customer_tel" value="{{$order->customer_tel}}" placeholder="Numer telefonu">
                        ...
                        <input type="datetime-local" class="form-control m-3" name="delivery" value="{{date('Y-m-d\TH:i', strtotime($order->delivery))}}" placeholder="Data dostawy">
                        <label for="exampleFormControlInput1" class="form-label">Email address</label>
                        <textarea class="form-control m-3" name="comments" id="" cols="30" rows="5" placeholder="Uwagi">
                            {{$order->comments}}
                        </textarea>
                        <br />
